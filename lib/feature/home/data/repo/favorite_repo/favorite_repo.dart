...
abstract class FavoriteRepo{
   Future<Either<Failure, AddToFavoriteResponse>> addProductsFavorite({required String productId});
      Future<Either<Failure, AddToFavoriteResponse>> deleteProductsFavorite({required String productId});
